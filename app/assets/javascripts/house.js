...
$(document).ready(function() {
		...
		$(".carousel-blur-img").mouseover(function(){
	  	$('.carousel-hover-content').show();
		});

		$(".carousel-blur-img").mouseout(function(){
	  	$('.carousel-hover-content').hide();
		});

		$(".message-btn-disabled").mouseover(function(){
	  	$('.message-hover-content').show();
		});

		$(".message-btn-disabled").mouseout(function(){
	  	$('.message-hover-content').hide();
		});

		$(".repairs-blur").mouseover(function(){
	  	$('.repair-hover-content').show();
		});

		$(".repairs-blur").mouseout(function(){
	  	$('.repair-hover-content').hide();
		});
